        ...
        <div className="bg-white w-1/3 h-2/3 rounded-full">
          <div className="border-teal p-8 border-t-12 bg-white mb-6 rounded-lg">
            ...
            <div className="flex justify-center my-6">
              <button className=" border-2 border-red-300 rounded">
                Sign Up With Google
              </button>
            </div>
            ...
            >
              <div class="mb-4 my-5 border-b-2 border-red-300">
                <label
                  class="text-center font-bold text-grey-darker block mb-2"
                  htmlFor="email"
                >
                  Email
                </label>
                <input
                  class="block appearance-none bg-transparent border-none w-full px-2 focus:outline-none "
                  id="email"
                  type="email"
                  placeholder="Email"
            ...
            <h1 className="text-center font-bold text-red-500 pt-16">
              Sign In
            </h1>
          </div>
        </div>
